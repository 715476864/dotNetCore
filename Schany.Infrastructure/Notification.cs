...
namespace Schany.Infrastructure
{
    /// <summary>
    /// 业务操作结果信息类，对操作结果进行封装
    /// </summary>
    public class Notification
    {
        ...
        public Notification(NotifyType notifyType)
        {
        ...
        public Notification(NotifyType notifyType, string message)
            : this(notifyType)
        {
            Message = message;
        }
        ...
        public Notification(NotifyType notifyType, string message, object appendData)
            : this(notifyType, message)
        {
        ...
        public Notification(NotifyType notifyType, string message, string logMessage)
            : this(notifyType, message)
        {
